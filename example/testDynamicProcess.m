...
separatorLevelTransmitter = LevelTransmitter(separator_1);
...
separatorLevelController =  ControllerDeviceBaseClass();
...
separatorPressureTransmitter = PressureTransmitter(separator_1.getGasOutStream());
...
separatorPressureController = ControllerDeviceBaseClass();
