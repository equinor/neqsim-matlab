...
wellStream = stream(system1,'�sgard well stream');
...
% �sgard pipeline
choke2 = valve(HP1cooler.getOutStream,110.0,'K�rst� choke');
seaCooler2 = heatexchanger(choke2.getOutStream,278.15,'sea cooler2');
inletSeparator2 = separator(seaCooler2.getOutStream(),'K�rst� inlet_separator');
